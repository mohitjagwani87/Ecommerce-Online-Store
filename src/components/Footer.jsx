...
const socialLinks = [
  { icon: <GitHubIcon />, label: 'GitHub', href: 'https://github.com/mohitjagwani87' },
  { icon: <LinkedInIcon />, label: 'LinkedIn', href: 'http://www.linkedin.com/in/mohit-kumar-jagwani-68b607251' },
  { icon: <LanguageIcon />, label: 'Portfolio', href: 'https://mohitjagwani.vercel.app/' },
  { icon: <EmailIcon />, label: 'Email', href: 'mailto:mohitkumarjagwani.2765@gmail.com' },
];
